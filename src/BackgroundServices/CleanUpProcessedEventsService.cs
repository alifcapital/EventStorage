...
internal class CleanUpProcessedEventsService<TEventRepository, TEventBox> : BackgroundService
    ...
    where TEventRepository : IEventRepository<TEventBox>
{
    ...
    public CleanUpProcessedEventsService(IServiceProvider services,
